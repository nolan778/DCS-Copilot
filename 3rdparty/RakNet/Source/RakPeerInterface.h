...
public:
	...
	virtual StartupResult Startup(unsigned int maxConnections, RakNet::TimeMS tickTimeMS, SocketDescriptor *socketDescriptors, unsigned socketDescriptorCount, int threadPriority = -99999) = 0;
	...
	virtual RakNet::TimeMS GetTickTime(void) const = 0;
